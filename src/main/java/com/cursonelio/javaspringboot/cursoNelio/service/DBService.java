...
public class DBService {
    ...
    public void instantiateTestDataBase() throws ParseException {
        ...
        Categoria cat6 = new Categoria(null, "Varanda");
        ...
        Cliente cli1 = new Cliente(null, "Maria Silva", "mariasilvia@hotmail.com", "243.176.440-02", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
        cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

        Cliente cli2 = new Cliente(null, "Ana Costa", "gigliotti@gmail.com", "402.455.480-84", TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
        ...
        Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, date.parse("20/10/2017 00:00"), null);
